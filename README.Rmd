...
<font size="1">Green checkmark ($\color{green}{\text{✓}}$ ) means we have that data while a red x ($\color{red}{\text{✘}}$ ) means **WE AS THE LAB CORE** are missing (some of) that specific information but it does exist.</font size>
