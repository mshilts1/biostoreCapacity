...
I'm going to attempt to put this on Shiny so it's easy for anyone to use, but will still make the source code transparent on GitHub.   
...
* Historical data (time series data on number of ECHO tubes store in the BioStore). ✓  
...
* Proportion of tubes from each kit type expected to be sent back to the biorepository. (e.g., may get only a tiny bit of urine from young babies, and so won't get all three 1.9ml tubes back.). ✘  
* 
