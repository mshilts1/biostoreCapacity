...
Eric Koplin has built a BRMS model using the forecast package to predict when the BioStore would be full based on the historical rate of filling and added some covariates:

```{r brms, echo = FALSE, eval = FALSE}
library(brms)
a <- single_brms_growth()
ggsave("man/figures/single_brms_growth.png", plot = a$plot, dpi = 300, width = 7, height = 5)
```
