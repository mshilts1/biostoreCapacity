...
Green checkmark ($\color{green}{\text{✓}}$ ) means we have that data, a yellow dot ($\color{yellow}{\text{◎}}$) means it's speculative estimated data that we can kind of guess at, while a red x ($\color{red}{\text{✘}}$ ) means WE'RE missing that specific information but it does exist.
