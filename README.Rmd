...
Speculative columns all contain the word "proportion" or "multiplier" in the name:     
    * `proportion_from_kit_collected`, `y_2025_multiplier`, `y_2026_multiplier`, `y_2027_multiplier`, `y_2028_multiplier`, `y_2029_multiplier`, `y_2030_multiplier`, `specialized_obesity_multiplier`, `specialized_chemphys_multiplier`, `specialized_lifestyle_multiplier`.   
