...
As the Lab Core does not have access to the UH3 MAP, we are instead using here data from the Measurement Core and the April 2025 F2F meeting of the Protocol Task Force.
